...
[^2]: [Magic: the Gathering product data available on Github](https://github.com/phil-cork/TimeSeries_Website/blob/main/_data/sealed_market_value.csv)
