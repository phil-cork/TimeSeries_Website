...
### Magic: the Gathering in 2022[^1]

[^1]: [Code for all data processing and data visualization](https://github.com/phil-cork/TimeSeries_Website/blob/main/_website_source/data-visualization.qmd)
...
###  Visualizing Magic: the Gathering Product Prices[^2]

[^2]: [Magic: the Gathering Product Price Data available on Github](https://github.com/phil-cork/TimeSeries_Website/blob/main/_data/sealed_market_value.csv)
...
### Magic: the Gathering Product Releases[^3]

[^3]: [Magic: the Gathering Product Release Data Available on Github](https://github.com/phil-cork/TimeSeries_Website/blob/main/_data/sets_over_time.csv)
